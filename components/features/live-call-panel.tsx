  ...
  return (
    <section className={PANEL_CLASS} style={PANEL_STYLE} aria-label="Live call" aria-live="polite">
      ...
      <div className="mt-4">
        <Link
          href={`/calls/${call.id}`}
          className="inline-flex w-full items-center justify-center gap-2 rounded-[10px] border border-gray-200 px-3 py-2 text-[13px] font-semibold text-navy transition-colors hover:bg-gray-50"
        >
      ...
      <p className="mt-3 flex items-center gap-1.5 text-[12px] text-gray-500">
        ...
        Transcript and recording appear on the call page when the call ends.
      </p>
    </section>
  );
}
